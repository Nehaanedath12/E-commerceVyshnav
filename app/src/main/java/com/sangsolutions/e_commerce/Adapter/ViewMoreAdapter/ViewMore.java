...
public class ViewMore {
    ...
    public ViewMore(String fPrice, String iId, String iSubCategory, String sAltLongDescription, String sAltName, String sAltShortDescription, String sCode, String sImagePath, String sLongDescription, String sName, String sShortDescription) {
        this.fPrice = fPrice;
        this.iId = iId;
