...
public class WishList {
   private String fPrice, iId, iSubCategory, sAltLongDescription, sAltName, sAltShortDescription, sCode, sImagePath, sLongDescription, sName,
    ...
    public WishList(String fPrice, String iId, String iSubCategory, String sAltLongDescription, String sAltName, String sAltShortDescription, String sCode, String sImagePath, String sLongDescription, String sName, String sShortDescription, String qty) {
        this.fPrice = fPrice;
        this.iId = iId;
