...
public class CategoryWiseProduct {
    private String fPrice, iId, iSubCategory, sAltLongDescription, sAltName, sAltShortDescription, sCode, sImagePath, sLongDescription, sName, sShortDescription;

    public CategoryWiseProduct(String fPrice, String iId, String iSubCategory, String sAltLongDescription, String sAltName, String sAltShortDescription, String sCode, String sImagePath, String sLongDescription, String sName, String sShortDescription) {
        this.fPrice = fPrice;
        this.iId = iId;
