...
public class Cart {
    ...
    public Cart(String fPrice, String iId, String iSubCategory, String sAltLongDescription, String sAltName, String sAltShortDescription, String sCode, String sImagePath, String sLongDescription, String sName, String sShortDescription, String Qty) {
        this.fPrice = fPrice;
        this.iId = iId;
